...
export default function AssignCourseMember(props) {
  ...
  const handleAssignCourseCoordinator = () => {
    axios({
      method: 'post',
      url: `${backendLink}/courses/assignCourseMember`,
      ...
      if (res.data.statusCode === 0) {
        props.setShowAlertMsg('Assigned successfully')
