...
export default function UnAssignCourseInst (props){
  ...
  const academicId = account.academicId
    ...
    const handleChange = (event) => {
      ...
      const handleUnAssign = () => {
        axios({
            method: 'post',
            url: `${backendLink}/courses/unassignCourseInstructor`,
            data: {
  ...
  <Card>
    ...
    <Accordion.Collapse eventKey="0">
      <Card.Body>
          ...
          <Button variant = 'contained' color='secondary' onClick={handleUnAssign}>Submit</Button>
      </Card.Body>
    </Accordion.Collapse>
  </Card>
