...
export default function UpdateSlot(props) {
  ...
  const handleCreateSlot = (e) => {
    axios({
      method: 'post',
      url: `${backendLink}/slots/updateSlot`,
        ...
        slot: {
          ...
          locationName:
            createState.locationName === ''
              ...
              : createState.locationName,
          courseId:
            createState.courseId === '' ? undefined : createState.courseId,
          assignedAcademicId:
      ...
      <Row>
        ...
        <Form.Group>
          <Form.Control
            ...
            value={createState['id'] !== undefined ? createState['id'] : ''}
            placeholder='Slot Id'
          ></Form.Control>
        </Form.Group>
        <Form.Group>
        ...
        <Form.Group>
          <Form.Control
            ...
            onChange={handleCreateSlotChange}
            value={
              createState['courseId'] !== undefined
                ? createState['courseId']
                : ''
            }
