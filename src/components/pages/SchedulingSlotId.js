    ...
    <Card className={classes.root}>
      ...
      {schedule.map((label, index) => {
                ...
                return (
                  ...
                  <Grid item xs={4} sm={2}>
                    <Paper className={classes.paper} > <div style={{display:'flex',flexDirection:'column'}}><div style={{marginTop:'1vw'}}>{label.dayOff === undefined ? label.firstSlot === null ? "FREE":label.firstSlot._id :"FREE" }</div></div></Paper>
                  </Grid>
                  <Grid item xs={4} sm={2}>
                  <Paper className={classes.paper}> <div style={{display:'flex',flexDirection:'column'}}><div style={{marginTop:'1vw'}}>{label.dayOff === undefined ? label.secondSlot === null ? "FREE":label.secondSlot._id :"FREE" }</div></div></Paper>
                  </Grid>
                  <Grid item xs={4} sm={2}>
                  <Paper className={classes.paper}> <div style={{display:'flex',flexDirection:'column'}}><div style={{marginTop:'1vw'}}>{label.dayOff === undefined ? label.thirdSlot === null ? "FREE":label.thirdSlot._id :"FREE" }</div></div></Paper>
                  </Grid>
                  <Grid item xs={4} sm={2}>
                  <Paper className={classes.paper}> <div style={{display:'flex',flexDirection:'column'}}><div style={{marginTop:'1vw'}}>{label.dayOff === undefined ? label.fourthSlot === null ? "FREE":label.fourthSlot._id :"FREE" }</div></div></Paper>
                  </Grid>
                  <Grid item xs={4} sm={2}>
                  <Paper className={classes.paper}> <div style={{display:'flex',flexDirection:'column'}}><div style={{marginTop:'1vw'}}>{label.dayOff === undefined ? label.fifthSlot === null ? "FREE":label.fifthSlot._id :"FREE" }</div></div></Paper>
                  </Grid>
                </Grid>
                )
          })}
